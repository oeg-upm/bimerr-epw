...
map:om_101 a rr:ObjectMap;
    rr:template "http://data.bimerr.iot.linkeddata.es/resource/weather/{epwName}/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
...
map:om_3 a rr:ObjectMap;
    rr:template "http://data.bimerr.iot.linkeddata.es/resource/weather/{epwName}/{adm03}_{city}_{wmo}/{adm03}_{city}_{wmo}";
    rr:termType rr:IRI.
...
map:s_62 a rr:SubjectMap;
    rr:template "http://data.bimerr.iot.linkeddata.es/resource/weather/{epwName}/{adm03}_{city}_{wmo}~iri".
